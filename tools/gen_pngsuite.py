...
def classify(data: bytes) -> Verdict:
    ...
    contiguous, IEND last and non-empty stream). a well-formed file with a
...
HEADER = '''
# PngSuite-2017jul19 corpus fixtures and png_info property tests
#
...
# background is composited, so alpha is preserved as decoded. the table is
# unreferenced until png_decode lands (it is blocked on DEFLATE inflate
# landing in mach-std); pngsuite_decodable hands a future decode test the
# pointer, length, and dimensions for the i-th entry.
'''
